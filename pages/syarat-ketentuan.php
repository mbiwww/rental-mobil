<?php
/**
 * pages/syarat-ketentuan.php — Halaman Syarat dan Ketentuan RentalKu
 *
 * Menampilkan syarat dan ketentuan layanan sewa mobil RentalKu.
...
<head>
  ...
  <title>RentalKu &middot; Syarat dan Ketentuan</title>
  <meta name="description" content="Syarat dan ketentuan layanan sewa mobil RentalKu. Baca sebelum melakukan pemesanan.">
  ...
  <div class="tnc-hero">
    <div class="container">
      <div class="tnc-hero-content">
        ...
        <p class="tnc-hero-desc">Harap baca dengan saksama sebelum menggunakan layanan sewa mobil RentalKu.</p>
      </div>
    </div>
  </div>
      ...
      <div class="col-lg-9">
        ...
        <section id="ketentuan-umum" class="tnc-section">
          <div class="tnc-card">
            ...
            <div class="tnc-content">
              <ol class="tnc-list">
                <li>Syarat dan ketentuan ini berlaku untuk seluruh layanan sewa mobil yang disediakan oleh <strong>RentalKu</strong>.</li>
                <li>Dengan melakukan pemesanan melalui platform RentalKu, penyewa dianggap telah membaca, memahami, dan menyetujui seluruh syarat dan ketentuan yang berlaku.</li>
                <li>RentalKu berhak mengubah syarat dan ketentuan ini sewaktu-waktu tanpa pemberitahuan terlebih dahulu. Perubahan berlaku sejak dipublikasikan di platform.</li>
          ...
          <div class="tnc-card">
            ...
            <div class="tnc-content">
              <ol class="tnc-list">
                ...
                <li>Penyewa wajib mendaftar akun di platform RentalKu dengan mengisi data yang valid, termasuk:
                  <ul>
                ...
                <li>RentalKu berhak menolak pemesanan apabila data penyewa tidak valid atau tidak lengkap.</li>
        ...
        <section id="pemesanan" class="tnc-section">
          <div class="tnc-card">
            ...
            <div class="tnc-content">
              <ol class="tnc-list">
                <li>Pemesanan dilakukan melalui platform RentalKu dengan memilih kendaraan, tanggal mulai, dan tanggal selesai sewa.</li>
                ...
                <li>RentalKu berhak menolak atau membatalkan pemesanan yang dianggap mencurigakan atau melanggar ketentuan.</li>
              </ol>
            </div>
          </div>
        </section>
        ...
        <section id="pembayaran" class="tnc-section">
          <div class="tnc-card">
            ...
            <div class="tnc-content">
              <ol class="tnc-list">
                <li>Pembayaran dilakukan melalui <strong>transfer bank</strong> ke rekening resmi RentalKu yang tertera di halaman pembayaran.</li>
        ...
        <section id="supir" class="tnc-section">
          <div class="tnc-card">
            ...
            <div class="tnc-content">
              <ol class="tnc-list">
                <li>RentalKu menyediakan opsi sewa <strong>dengan supir</strong> atau <strong>tanpa supir</strong> (lepas kunci).</li>
                  ...
                  <div class="tnc-option-grid">
                    <div class="tnc-option-card">
                      ...
                      <div>
                        ...
                        <p>Ambil kendaraan langsung di kantor RentalKu.</p>
                      </div>
                    </div>
                    <div class="tnc-option-card">
                  ...
                  <div class="tnc-option-grid">
                    <div class="tnc-option-card">
                      ...
                      <div>
                        ...
                        <span class="tnc-badge-free">Gratis</span>
                        <p>Kembalikan kendaraan langsung ke kantor RentalKu.</p>
                      </div>
                    </div>
                    <div class="tnc-option-card">
                      ...
                      <div>
                        ...
                        <p>Kendaraan dijemput oleh tim RentalKu di lokasi Anda.</p>
                      </div>
                    </div>
                  </div>
                </li>
          ...
          <div class="tnc-card">
            ...
            <div class="tnc-content">
              <ol class="tnc-list">
                ...
                <li>Pengembalian dilakukan ke lokasi yang telah disepakati (kantor RentalKu atau lokasi dropoff yang dipilih).</li>
                ...
                <li>Pengecekan kondisi kendaraan akan dilakukan oleh tim RentalKu pada saat pengembalian.</li>
              </ol>
            </div>
          </div>
        </section>
          ...
          <div class="tnc-card">
            ...
            <div class="tnc-content">
              <ol class="tnc-list">
                ...
                <li>Pengajuan refund akan diproses oleh admin dan keputusan akhir berada di pihak RentalKu.</li>
          ...
          <div class="tnc-card">
            ...
            <div class="tnc-content">
              <ol class="tnc-list">
                ...
                <li>RentalKu tidak bertanggung jawab atas barang pribadi penyewa yang tertinggal di dalam kendaraan.</li>
                <li>Dalam hal kecelakaan, penyewa wajib segera melapor kepada pihak kepolisian dan RentalKu.</li>
                <li>RentalKu berhak menuntut ganti rugi atas kerusakan kendaraan yang disebabkan oleh kelalaian penyewa.</li>
              </ol>
            </div>
          </div>
        </section>
        ...
        <!-- CTA -->
        <div class="tnc-cta">
          <p>Dengan menggunakan layanan RentalKu, Anda dianggap telah menyetujui seluruh syarat dan ketentuan di atas.</p>
